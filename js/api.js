...
// GitHub Pages отдаёт статический фронт, даже когда origin API недоступен.
// В этом случае упавшие запросы к бэкенду редиректят пользователя на статическую
// страницу-заглушку, вместо того чтобы оставлять пустой интерфейс.
